...
//
// class ExceptionRotationContainer extends StatefulWidget {
//   ExceptionRotationContainer({
//     super.key,
//     required this.color,
...
//   final Color color;
//   final Rotation rotationListModel;
//   final bool duration;
//   final bool endDate;
//   Color? containercolor;
//
//   @override
//   State<ExceptionRotationContainer> createState() => _ExceptionRotationContainerState();
// }
//
// class _ExceptionRotationContainerState extends State<ExceptionRotationContainer> {
...
//                           children: [
//                             Text(
//                               "${widget.rotationListModel.startDate.day}",
//                               // '14',
//                               textAlign:
//                               TextAlign.start,
...
//                             // ),
//                             Text(
//                               getMonthString(widget.rotationListModel.startDate.month),
//                               textAlign:
//                               TextAlign.start,
//                               style: Theme.of(context)
//                                   .textTheme
...
//                               ),
//                               child: Text(
//                                 widget.rotationListModel.rotationTitle,
//                                 maxLines: 2,
...
//                                   Expanded(
//                                     child: Text(
//                                       widget.rotationListModel.hospitalTitle,
//                                       maxLines: 2,
//                                       overflow: TextOverflow.ellipsis,
//                                       style: Theme.of(context)
//                                           .textTheme
...
//                                   Expanded(
//                                     child: Text(
//                                       widget.rotationListModel.courseTitle,
//                                       maxLines: 1,
//                                       overflow: TextOverflow.ellipsis,
//                                       style: Theme.of(context)
//                                           .textTheme
