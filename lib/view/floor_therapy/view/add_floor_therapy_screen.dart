...
class AddFloorTherapyScreen extends StatefulWidget {
  ...
  @override
  State<AddFloorTherapyScreen> createState() => _AddFloorTherapyScreenState();
}

class _AddFloorTherapyScreenState extends State<AddFloorTherapyScreen> {
  List<String> items = [];
    ...
    return WillPopScope(
      ...
      child: SafeArea(
        child: Scaffold(
          ...
          appBar: CommonAppBar(
            title: 'Create Floor Therapy Evaluation',
            fontSize: 20,
            // merge: true,
          ),
          body: NoInternet(
