...
class AddMidtermScreen extends StatefulWidget {
  ...
  @override
  State<AddMidtermScreen> createState() => _AddMidtermScreenState();
}

class _AddMidtermScreenState extends State<AddMidtermScreen> {
  List<String> items = [];
    ...
    return WillPopScope(
      ...
      child: SafeArea(
        child: Scaffold(
          ...
          appBar: CommonAppBar(
            title: 'Create Midterm Evaluation',
            // merge: true,
          ),
          body: Container(
            child: Padding(
                            ...
                            onTap: () async {
                              ...
                              if (EvaulationDateText.text.isNotEmpty &&
                                ...
                                final DataResponseModel dataResponseModel =
                                    await dataService.addMidterm(request);
