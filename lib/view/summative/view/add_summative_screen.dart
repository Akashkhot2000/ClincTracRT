...
class AddSummativeScreen extends StatefulWidget {
  ...
  @override
  State<AddSummativeScreen> createState() => _AddSummativeScreenState();
}

class _AddSummativeScreenState extends State<AddSummativeScreen> {
  List<String> items = [];
    ...
    return WillPopScope(
      ...
      child: SafeArea(
        child: Scaffold(
          ...
          appBar: CommonAppBar(
            title: 'Create Summative Evaluation',
            fontSize: 21,
            // merge: true,
          ),
          body: NoInternet(
                              ...
                              onTap: () async {
                                ...
                                if (EvaulationDateText.text.isNotEmpty &&
                                  ...
                                  final DataResponseModel dataResponseModel =
                                      await dataService.addSummative(request);
