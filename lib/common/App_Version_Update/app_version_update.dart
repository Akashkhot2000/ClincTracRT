...
import 'package:clinicaltrac/common/App_Version_Update/update_version_screen.dart';
import 'package:flutter/material.dart';

class CTAppVersionUpdate {
  ...
  static showAlertUpdate(
      {BuildContext? context,
        ...
        String? content = 'Please update your application',
    ...
    await showDialog(
      ...
      onWillPop: () => Future.value(!mandatory!),
      child:UpdateVersionDialogScreen(
        appVersionResult: appVersionResult,
