...
/// [ExpansionTileContainer] to save and restore its expanded state when it is scrolled
/// in and out of view.
///
...
/// to the [leading] and [trailing] properties of [ExpansionTileContainer].
///
/// {@tool dartpad}
...
class _ExpansionTileContainerState extends State<ExpansionTileContainer> with SingleTickerProviderStateMixin {
  ...
  Widget? _buildIcon(BuildContext context) {
    return RotationTransition(
      turns: _iconTurns,
      child:Icon(Icons.keyboard_arrow_down_rounded,size: globalWidth * 0.08,color: Colors.black,),
      // child: SvgPicture.asset("assets/images/exception.svg"),
    );
  }
