...
class CommonGridComponent extends StatefulWidget {
   CommonGridComponent(
      {super.key,
  ...
  @override
  State<CommonGridComponent> createState() => _MyWidgetState();
}

class _MyWidgetState extends State<CommonGridComponent> {
        ...
        return GestureDetector(
          onTap: () {
            ...
            switch (widget.activeOptions[index]) {
              case 0:
                Navigator.pushNamed(context, Routes.drInteractionListScreen,
                    arguments: DrInteractionListScreenDta(
                        showAdd: true, rotation: widget.rotation));
                break;
              case 1:
                Navigator.pushNamed(context, Routes.dailyJournalScreen,
                    arguments: DailyRoutingData(
                        rotation: widget.rotation,
                        route: DailyJournalRoute.rotation));
                break;
              case 2:
