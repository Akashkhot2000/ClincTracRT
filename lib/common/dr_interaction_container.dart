...
class DrInteractionContainer extends StatefulWidget {
  DrInteractionContainer({
    super.key,
    required this.color,
  ...
  final UniDrInteractionList drIntraction;
  ...
  @override
  State<DrInteractionContainer> createState() => _DrInteractionContainerState();
}

class _DrInteractionContainerState extends State<DrInteractionContainer> {
                      ...
                      children: [
                        Row(
                          ...
                          children: [
                            ...
                            if (widget.drIntraction.pointsAwarded.isNotEmpty)
                              Container(
                                height: 70,
                                width: 60,
                                decoration: BoxDecoration(
                  ...
                  Container(
                    ...
                    child: Padding(
                      ...
                      child: Align(
                        ...
                        child: (widget.drIntraction.clinicianDate.isEmpty)
                            ? Row(
                                mainAxisAlignment:
