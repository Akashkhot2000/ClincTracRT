...
class ExpansionTileCardState extends State<ExpansionTileCard>
  ...
  void toggleExpansion() {
    // log("Expansion called");
    if (widget.enabled!) _setExpansion(!_isExpanded);
  }
            ...
            children: <Widget>[
              GestureDetector(
                ...
                child: ListTileTheme.merge(
                  iconColor: widget.enabled! ? _iconColor.value : Colors.white,
                  ...
                  child: Padding(
                    ...
                    child: ListTile(
                        ...
                        // trailing:
                        //     widget.trailing ?? const Icon(Icons.expand_less),
                        ),
                  ),
                ),
              ),
