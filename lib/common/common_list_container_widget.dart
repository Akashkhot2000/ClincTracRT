...
class CommonListContainerWidget extends StatefulWidget {
  ...
  @override
  State<CommonListContainerWidget> createState() =>
      _CommonListContainerWidgetState();
}

class _CommonListContainerWidgetState extends State<CommonListContainerWidget> {
  @override
        ...
        children: [
          Container(
            ...
            child: Column(
              ...
              children: [
                Padding(
                  padding: EdgeInsets.only(top:10,left:15,right:5,bottom:5),
                  child: Column(
                    mainAxisAlignment: MainAxisAlignment.start,
                    crossAxisAlignment: CrossAxisAlignment.start,
                    children: [
                      Row(children: [
                        widget.date != null || widget.monthTitle != null
                            ? Padding(
                            ...
                            Padding(
                              ...
                              child: Row(
                                ...
                                children: [
                                  NullCheckWidget(
                                    child: SizedBox(
                                      width: widget.statusString == "Pending"
                                          ? globalWidth * 0.68
                                          : widget.statusString == "Completed"
                                              ? globalWidth * 0.63
                                              : globalWidth * 0.65,
                                      child: Text(
                                        "${widget.mainTitle}",
