                        ...
                        if (!widget.rotation.isExpired)
                          Visibility(
                            visible: widget.rotation.isClockIn == 2
                                && widget.activeStatus == Active_status.inactive
                                ? false
                                : true,
                            child: Padding(
                              padding: const EdgeInsets.only(
                              ...
                              child: GestureDetector(
                                onTap: () async {
                                  ...
                                  if (widget.rotationListModel.data
                                              .isClockedIn ==
                                          true &&
                                      // store.state.activeRotationStatus.isRotationActive == false &&
                                  ...
                                  if (store.state.activeRotationStatus
                                              .isRotationActive ==
                                          true &&
                                      widget.rotation.rotationId !=
                                          "${store.state.activeRotationStatus.rotationId}") {
                                    AppHelper.buildErrorSnackbar(context,
                                        "${store.state.activeRotationStatus.rotationName} rotation is already running");
                                    return;
                                  }
                                  startTimer();
                                  // if (objPosition == null) {
                                ...
                                child: Visibility(
                                  ...
                                  replacement: Visibility(
                                    visible: widget.activeStatus != Active_status.inactive,
                                    child: Container(
                                      decoration: BoxDecoration(
                                        color: Color(0xFFF1F5F5),
                                        // color: widget.rotation.isClockIn == 0
                                        //     ? Color(Hardcoded.primaryGreen)
                                        //         .withOpacity(0.2)
                                        //     : widget.rotation.isClockIn == 1
