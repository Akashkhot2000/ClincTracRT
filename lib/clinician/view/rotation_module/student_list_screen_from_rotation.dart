...
class StudentListScreenFromRotation extends StatefulWidget {
  const StudentListScreenFromRotation({required this.rotationId,required this.searchText,
...
final bool isSearchClicked;
  @override
  State<StudentListScreenFromRotation> createState() => _StudentListScreenFromRotationState();
}

class _StudentListScreenFromRotationState extends State<StudentListScreenFromRotation> {
  int pageNo = 1;
  int lastpage = 1;
    ...
    return Scaffold(
      ...
      body: Stack(
        children: [
          Padding(
            padding:
            EdgeInsets.only(top:globalHeight * 0.01
            ),
            child: Visibility(
