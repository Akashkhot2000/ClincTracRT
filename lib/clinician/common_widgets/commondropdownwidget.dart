...
class CoomonDropDownwidget extends StatefulWidget {
  CoomonDropDownwidget(
      {super.key,
      required this.items,
      required this.title,
      this.inputText,
  ...
  @override
  State<CoomonDropDownwidget> createState() => _CoomonDropDownState();
}

class _CoomonDropDownState extends State<CoomonDropDownwidget> {
  bool isOpen = false;
